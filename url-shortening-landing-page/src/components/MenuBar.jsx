...
const MenuBar = () => {
    ...
    return (
        <div className="sm:flex sm:flex-col sm:gap-5 sm:bg-darkviolet sm:px-5 sm:py-10 sm:items-center w-11/12 rounded-xl text-white absolute top-24 left-1/2 right-1/2 -translate-x-1/2 z-20 md:w-10/12">
