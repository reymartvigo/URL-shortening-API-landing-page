...
const Footer = () => {
    return (
        <div className="sm:flex sm:flex-col sm:gap-16 sm:items-center sm:text-center sm:py-20 bg-verydarkviolet text-white lg:flex-row  lg:justify-between lg:px-28 lg:items-start xl:px-40">
            ...
            <div className="sm:flex sm:flex-col sm:gap-10 lg:flex-row lg:text-left xl:gap-24">
                <div className="sm:flex sm:flex-col gap-4">
                    <span className="font-bold text-lg">Features</span>
                    <ul className="sm:flex sm:flex-col sm:gap-3 text-neutralgray tracking-wide">
                ...
                <div className="sm:flex sm:flex-col gap-4">
                    ...
                    <ul className="sm:flex sm:flex-col sm:gap-3 text-neutralgray tracking-wide">
                        ...
                        <li className="cursor-pointer hover:text-cyan">Out Team</li>
                ...
                <div className="sm:flex sm:flex-col gap-4">
                    ...
                    <ul className="sm:flex sm:gap-5  sm: justify-center">
                        <img className="sm:w-6 cursor-pointer" src={facebook} alt="" aria-hidden="true" loading="lazy"></img>
                        <img className="sm:w-6 cursor-pointer" src={twitter} alt="" aria-hidden="true" loading="lazy"></img>
                        <img className="sm:w-6 cursor-pointer" src={instagram} alt="" aria-hidden="true" loading="lazy"></img>
                        <img className="sm:w-6 cursor-pointer" src={pinterest} alt="" aria-hidden="true" loading="lazy"></img>
                    </ul>
                </div>
